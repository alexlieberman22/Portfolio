...
public class Recursion {
    ...
    public static boolean isPalindrome(String word){
    	...
    	char B= Character.toLowerCase(word.charAt(word.length()-1));
    ...
    public static String dedupeChars(String word){
    	int i=0;
    	return dedupeChars(word,i);
    }
    public static String dedupeChars(String word,int i){
    	if(i >= word.length()-1){
    		return word;
    	}
    	...
    	if (result == 0){
    		String sub= word.substring(0,i+1)+ word.substring(i+2);
    		return dedupeChars(sub,i);
    	}
    	
    	return dedupeChars(word,i+1);
    }
